...
void run() {
    ...
    // Event subscription logic (added as requested)
...
// Handles both method responses and event notifications
void on_message(const std::shared_ptr<vsomeip::message> &_response) {
    ...
    // Affichage clair si c'est une réponse
...
int main() {
    ...
    // Register for both method responses and events
